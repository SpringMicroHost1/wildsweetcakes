...
export function load(data:{ params:any }) {
    if (procedureData[data.params.procedure]) {
        let returnObject = {
            title: procedureData[data.params.procedure].title,
            metaDescription: procedureData[data.params.procedure].metaDescription || procedureData[data.params.procedure].content.find(a=>typeof a === "string") || defaultDescription,
            content: "",
        }
        procedureData[data.params.procedure].content.forEach(section=>{
